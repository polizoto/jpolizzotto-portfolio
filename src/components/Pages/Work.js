      ...
      <div>
        ...
        <div className="projects">
            ...
            <div id="techscoop" tabindex="0" className="project">
                <div className="img__description">
                <a className="" aria-label="Full Stack Application - Tech Blog" href="https://immense-badlands-14812.herokuapp.com/"rel="noreferrer" target="_blank"><h3>Tech Development Scoop</h3></a>
            ...
            <div id="bash_script" tabindex="0" className="project">
                <div className="img__description">
                <a className="" aria-label="Full Stack Application - Tech Blog" href="https://www.youtube.com/watch?v=ophpILKTVNI"rel="noreferrer" target="_blank"><h3>DOCX-HTML Bash Script</h3></a>
            ...
            <div id="manager-express" tabindex="0" className="project">
                <div className="img__description">
                <a className="" aria-label="Full Stack Application - Tech Blog" href="https://www.dropbox.com/s/pqkkrct2wip16op/Employeemanagerexpress_captioned.mp4?dl=0"rel="noreferrer" target="_blank"><h3>Employee Manager Express</h3></a>
            ...
            <div id="cash-flow" tabindex="0" className="project">
                <div className="img__description">
                <a className="" aria-label="Full Stack Application - Tech Blog" href="https://stark-bastion-02307.herokuapp.com/"rel="noreferrer" target="_blank"><h3>Cash Flow Analyzer</h3></a>
            ...
            <div id="author" tabindex="0" className="project">
                <div className="img__description">
                <a className="" aria-label="Full Stack Application - Tech Blog" href="https://polizoto.github.io/find-an-author/"rel="noreferrer" target="_blank"><h3>Find An Author!</h3></a>
